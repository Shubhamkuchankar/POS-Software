...
class bill_window:
    #print billlllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll
    
    
    def mail(self):
        mail = Toplevel(biller)
        mail.geometry("764x700+500+100")
        mail.title("Email")
        mail.resizable(0,0)

        
        mail.label = Label(mail)
        mail.label.place(relx=0, rely=0, width=764, height=488)
        mail.img = PhotoImage(file="images/bill.png")
        mail.label.configure(image=mail.img)
        mail.scrolledtext = tkst.ScrolledText(mail)
        mail.scrolledtext.place(x=33,y=198, width=695, height=275)
        mail.scrolledtext.configure(borderwidth=0)
        mail.scrolledtext.configure(font="-family {Podkova} -size 8")
        text = self.Scrolledtext1.get('1.0', END)
        mail.scrolledtext.insert("insert", text)
        mail.scrolledtext.configure(state="disabled")
        
        #labelsss customer date bill no mobile
        mail.custn_label = Label(mail)
        mail.custn_label.place(relx=0.175, rely=0.140, width=100, height=26)
        mail.custn_label.configure(font="-family {Poppins} -size 8")
        mail.custn_label.configure(anchor="w")
        mail.custn_label.configure(text=self.entry1.get())

        mail.billn_label = Label(mail)
        mail.billn_label.place(relx=0.148, rely=0.169, width=100, height=26)
        mail.billn_label.configure(font="-family {Poppins} -size 7")
        mail.billn_label.configure(anchor="w")
        mail.billn_label.configure(text=str(cust_new_bill.get()))
        
        mail.mobn_label = Label(mail)
        mail.mobn_label.place(relx=0.850, rely=0.140, width=70, height=26)
        mail.mobn_label.configure(font="-family {Poppins} -size 8")
        mail.mobn_label.configure(anchor="w")
        mail.mobn_label.configure(text=self.entry2.get())
        
        mail.billdate_label = Label(mail)
        mail.billdate_label.place(relx=0.780, rely=0.169, width=70, height=26)
        mail.billdate_label.configure(font="-family {Poppins} -size 7")
        mail.billdate_label.configure(anchor="w")
        mail.billdate_label.configure(text=(str(date.today())))
                   
        
        def save_as_image():
            
            mail.Save_button.destroy()
            file_path = filedialog.asksaveasfilename(defaultextension=".png", filetypes=[("PNG files", "*.png")])
            if file_path:
                # Grab the root window's content as an image
                x = mail.winfo_rootx()
                y = mail.winfo_rooty()
                w = mail.winfo_width()
                h = mail.winfo_height()
                ...
                #mail.status_label.config(text=f"Image saved: {file_path}")
                messagebox.showinfo("Success!!", "Bill Saved")
                mail.destroy()
        
        mail.Save_button = Button(mail)
        mail.Save_button.place(x=340, y=490, width=90, height=30)
        mail.Save_button.configure(relief="flat")
        mail.Save_button.configure(overrelief="flat")
        mail.Save_button.configure(activebackground="#CF1E14")
        mail.Save_button.configure(cursor="hand2")
        mail.Save_button.configure(foreground="#ffffff")
        mail.Save_button.configure(background="#CF1E14")
        mail.Save_button.configure(font="-family {Poppins SemiBold} -size 12")
        mail.Save_button.configure(borderwidth="0")
        mail.Save_button.configure(text="Save Bill")
        mail.Save_button.configure(command=save_as_image)
        
    #print billlllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll 
    def discount(self):
        global disc
        s = int(self.discountEntry.get())
    ...
    def __init__(self, top=None):
        ...
        self.button3.place(relx=0.048, rely=0.888, width=86, height=25)
        ...
        self.button4.place(relx=0.141, rely=0.888, width=84, height=25)
        ...
        self.button5.place(relx=0.230, rely=0.888, width=86, height=25)
        ...
        self.button6.place(relx=0.318, rely=0.888, width=86, height=25)
        ...
        self.button7.place(relx=0.125, rely=0.674, width=86, height=26)
        ...
        self.button8.place(relx=0.300, rely=0.674, width=84, height=26)
        ...
        self.button9.place(relx=0.220, rely=0.674, width=68, height=26)
        ...
        self.btn10 =Button(biller)
        self.btn10.place(relx=0.054, rely=0.805, width=68, height=26)
        self.btn10.configure(relief="flat")
        self.btn10.configure(overrelief="flat")
        self.btn10.configure(activebackground="#CF1E14")
        self.btn10.configure(cursor="hand2")
        self.btn10.configure(foreground="#ffffff")
        self.btn10.configure(background="#CF1E14")
        self.btn10.configure(font="-family {Poppins SemiBold} -size 10")
        self.btn10.configure(borderwidth="0")
        self.btn10.configure(text="""Discount""")
        self.btn10.configure(command=self.discount)
        """
        self.btn11 =Button(biller)
        self.btn11.place(relx=0.322, rely=0.807, width=68, height=26)
        self.btn11.configure(relief="flat")
        self.btn11.configure(overrelief="flat")
        self.btn11.configure(activebackground="#CF1E14")
        self.btn11.configure(cursor="hand2")
        self.btn11.configure(foreground="#ffffff")
        self.btn11.configure(background="#CF1E14")
        self.btn11.configure(font="-family {Poppins SemiBold} -size 10")
        self.btn11.configure(borderwidth="0")
        self.btn11.configure(text="Save Bill")
        self.btn11.configure(command="")"""
        text_font = ("Poppins", "8")
        ...
        self.discountEntry = ttk.Entry(biller)
        self.discountEntry.place(relx=0.145, rely=0.805, width=50, height=24)
        self.discountEntry.configure(font="-family {Poppins} -size 10")
    ...
    def add_to_cart(self):
        ...
        if strr.find('Total')==-1:
            global product_name,product_qty, sp
            product_name = self.combo3.get()
            if(product_name!=""):
    ...
    def total_bill(self):
        ...
        if self.cart.isEmpty():
            ...
            if strr.find('Total')==-1:
                ...
                total = "\nAfter Discount Amt\t\t\t\t\t\t\t\t\t\t\t\t        Rs. {}.0".format(self.discount())
                self.Scrolledtext1.insert('insert', total)
                divider2 = "\n"+("─"*84)
        ...
        if self.state == 1:
            ...
            if(cust_name.get()==""):
                ...
                if strr.find('Total')==-1:
                    ...
                    a = int(self.discountEntry.get())
                    b = int(self.cart.total())
                    c = b - a
                    with sqlite3.connect("./Database/store.db") as db:
                        cur = db.cursor()
                        insert = ("INSERT INTO disc (rs) VALUES(?)")
