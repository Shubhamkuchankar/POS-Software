...
def about():
    sure = messagebox.showinfo("About Us","Ganesh Nutrition\nA Supplement Store,Owner Ganesh Khirsagar \nSoftware Developed By:Mr.Shubham Kuchankar Private LTD.", parent=adm)
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@        
        #total revenuee labels
        self.dash = Label(inv,width=92,height=1)
        self.dash.place(x=409,y=623)
        self.dash.configure(text="_________________________________________________________________________________________________________")
        self.dash.configure(font="-family {Arial Rounded MT Bold} -size 12")
        self.dash.configure(borderwidth=5)
        self.dash.configure(foreground="Orangered")  
        
        self.costprice = Label(inv,width=10,height=1)
        self.costprice.place(x=409,y=630)
        self.costprice.configure(text="Cost Price")
        self.costprice.configure(font="-family {Arial Rounded MT Bold} -size 12")
        
        self.totalcost = Label(inv,width=11,height=1)
        self.totalcost.place(x=420,y=670)
        self.totalcost.configure(text="Total Cost Rs:")
        self.totalcost.configure(font="-family {Arial Rounded MT Bold} -size 10")
        
        self.saleprice = Label(inv,width=10,height=1)
        self.saleprice.place(x=660,y=630)
        self.saleprice.configure(text="Sale Price")
        self.saleprice.configure(font="-family {Arial Rounded MT Bold} -size 12")

        self.Totalsale = Label(inv,width=11,height=1)
        self.Totalsale.place(x=655,y=670)
        self.Totalsale.configure(text="Total Rs:")
        self.Totalsale.configure(font="-family {Arial Rounded MT Bold} -size 10")
        
        
        
        with sqlite3.connect("./Database/store.db") as db:
            cur = db.cursor()
            cur.execute("Select stock,cost_price from  raw_inventory")
            rows = cur.fetchall()
            results=[]
            for row in rows:
                result = row[0] * row[1]
            ...
            text1 = (sum(results))
        self.totalt = Label(inv,width=8,height=1)
        self.totalt.place(x=516,y=670)
        self.totalt.configure(text=text1)
        self.totalt.configure(foreground="red")       
        self.totalt.configure(font="-family {Arial Rounded MT Bold} -size 10")
        db.close()
        self.add()
    ...
    def add(self):
        ...
        with sqlite3.connect("./Database/store.db") as db:
            ...
            db.commit()
        text2 = (sum(rs))
        self.Totala = Label(inv,width=8,height=1)
        self.Totala.place(x=735,y=670)
        self.Totala.configure(text=text2)
        self.Totala.configure(foreground="red")
        self.Totala.configure(font="-family {Arial Rounded MT Bold} -size 10")    
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        ...
        self.tree.place(relx=0.307, rely=0.203, width=880, height=460)
        self.tree.configure(
